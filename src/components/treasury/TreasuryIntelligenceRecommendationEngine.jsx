...
export default function TreasuryIntelligenceRecommendationEngine() {
  const recommendation = {
    ...
    confidence: "92%",
    readiness: "READY",
    nextStep: "Continue treasury monitoring and maintain reserve discipline.",
    reason:
      "Current liquidity condition remains stable with no significant governance pressure detected.",
  };

  return (
    <section className="treasury-intelligence-recommendation">
      <div className="treasury-recommendation-card">
        <div className="treasury-recommendation-header">
          <div>
            ...
            <p className="treasury-section-description">
               ...
               governance exposure and operational readiness.
            </p>
          </div>
